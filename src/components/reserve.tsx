    ...
    <section id="res" className="relative bg-[#8b1e1e] py-24 px-6 md:px-12 text-white overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="text-center mb-12">
          <span className="text-[11px] font-bold tracking-[0.3em] text-amber-400 uppercase block mb-3">
            Reservations
          </span>
          <h2 className="font-serif text-5xl text-white tracking-wide mb-4">
            Book your table
          </h2>
          <p className="text-sm text-zinc-300 font-light tracking-wide">
            Reserve in seconds — we'll confirm within the hour.
          </p>
        </div>

        <div className="bg-white/[0.04] backdrop-blur-md border border-white/[0.08] p-8 md:p-12 rounded-xl shadow-2xl">
          <form className="space-y-6" onSubmit={handleReserveSubmit}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="flex flex-col space-y-1.5">
                ...
                >
                  <option value="1 guest" className="bg-zinc-900 text-white">1 guest</option>
                  <option value="2 guests" className="bg-zinc-900 text-white">2 guests</option>
                  <option value="3 guests" className="bg-zinc-900 text-white">3 guests</option>
                  <option value="4 guests" className="bg-zinc-900 text-white">4 guests</option>
                  <option value="5+ guests" className="bg-zinc-900 text-white">5+ guests</option>
                </select>
              </div>
            </div>
            ...
            <div className="flex justify-end pt-2">
              <button 
                type="submit"
                disabled={isPending}
                className="bg-[#dca43a] hover:bg-[#c5912e] disabled:bg-zinc-500 text-neutral-900 font-sans text-xs font-bold tracking-[0.2em] uppercase py-3.5 px-8 rounded transition-colors shadow-lg"
              >
